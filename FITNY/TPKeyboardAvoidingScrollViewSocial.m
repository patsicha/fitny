...
#import "TPKeyboardAvoidingScrollViewSocial.h"

#define _UIKeyboardFrameEndUserInfoKey (&UIKeyboardFrameEndUserInfoKey != NULL ? UIKeyboardFrameEndUserInfoKey : @"UIKeyboardBoundsUserInfoKey")

const CGFloat kCalculatedContentPaddingSocial = 10;

@interface TPKeyboardAvoidingScrollViewSocial () <UITextFieldDelegate, UITextViewDelegate> {
...
@implementation TPKeyboardAvoidingScrollViewSocial
...
- (void)keyboardWillShow:(NSNotification*)notification {
    if ( CGSizeEqualToSize(self.contentSize, CGSizeZero) ) {
        ...
        self.contentSize = CGSizeMake(_contentsSize.width + kCalculatedContentPaddingSocial, _contentsSize.height + kCalculatedContentPaddingSocial);
    }
