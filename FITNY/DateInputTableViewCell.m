...
// Initialization code
	...
	if (self.datePicker.datePickerMode == UIDatePickerModeCountDownTimer) {
        ...
        self.textLabel.text = [self timerStringValue];
    } else {
        
        self.textLabel.text = @"Choose";
    }
}
...
- (BOOL)becomeFirstResponder {
	if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
		...
		[popoverController presentPopoverFromRect:self.textLabel.frame inView:self permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
...
- (void)setDateValue:(NSDate *)value {
    ...
    if (self.datePicker.datePickerMode == UIDatePickerModeCountDownTimer) {
        ...
        self.textLabel.text = [dateFormatter2 stringFromDate:self.dateValue];
    }
}
...
- (void)setDatePickerMode:(UIDatePickerMode)mode {
    ...
    if (self.datePicker.datePickerMode == UIDatePickerModeCountDownTimer) {
        ...
        self.timerValue = 0;
        self.textLabel.text = [self.dateFormatter stringFromDate:self.dateValue];
    }
}
