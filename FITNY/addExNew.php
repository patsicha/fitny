<?
	...
	$strSQL = "INSERT INTO `program`(`userid`, `name`, `type`) VALUES (".$userid.",'".$name."','".$type."')";
	mysql_query("SET NAMES UTF8");
	$objQuery = mysql_query($strSQL);
	$strSQL = "SELECT * FROM program WHERE 1";
	mysql_query("SET NAMES UTF8");
	$objQuery = mysql_query($strSQL);
	$intNumRow = mysql_num_rows($objQuery);

	$strSQL="INSERT INTO `program_detail`(`id`, `exerciseID`, `amount`) VALUES (".$intNumRow.",'".$exid."','".$exAmount."')";
	mysql_query("SET NAMES UTF8");
	$objQuery = mysql_query($strSQL);
