...
#import "DateInputTableViewCell2.h"

@implementation DateInputTableViewCell2
...
- (void)initalizeInputView {
	...
	if (self.datePicker.datePickerMode == UIDatePickerModeCountDownTimer) {
        ...
        self.detailTextLabel.text = @"Choose";
    }
}
...
- (void)setDateValue:(NSDate *)value {
    ...
    if (self.datePicker.datePickerMode == UIDatePickerModeCountDownTimer) {
        ...
        self.detailTextLabel.text = [dateFormatter2 stringFromDate:self.dateValue];
    }
}
